...
# Física Computacional 2026 — Organización de la materia
...
- Karen Hallberg (karen.hallberg@ib.edu.ar)
...
Las reglas completas están en [Trabajo con IA](trabajo-con-ia.md).
...
- **Grupos de cuatro** con roles que rotan en cada trabajo práctico. Ver
  [Grupos y presentaciones](grupos-y-revision.md).
- **La unidad de trabajo es una afirmación auditable**, no un notebook
  terminado. Ver [Paquete de afirmación](paquete-de-afirmacion.md).
...
adaptar lo que entregan. Detalle y rúbrica en [Evaluación](evaluacion.md).
...
una herramienta de IA común. Instrucciones en [Instalación](instalacion.md).
...
- G. Abramson, [*Notas de Física Computacional*](https://drive.google.com/file/d/1Zv_vW3wvVkFlZEIgmR6r08vysiWJYUvv/view?usp=sharing)
  (2022), Instituto Balseiro. Buena introducción en castellano a varios temas.
- W. H. Press *et al.*, *Numerical Recipes*, 3.ª ed., Cambridge University
  Press, 2007.
- J. Thijssen, *Computational Physics*, 2.ª ed., Cambridge University Press,
  2007.
- W. Krauth, *Statistical Mechanics: Algorithms and Computations*, Oxford
  University Press, 2006.
- R. H. Landau, M. J. Páez y C. C. Bordeianu, *Computational Physics: Problem
  Solving with Python*, Wiley, 2015.
- S. E. Koonin y D. C. Meredith, *Computational Physics*, Addison-Wesley,
  1990.
